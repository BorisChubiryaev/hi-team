      ...
      <main className="mx-auto max-w-4xl px-4 py-6 sm:px-6">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-muted">
            Роли, доступ, персональные напоминания и отпуска. Деактивированные
            не могут войти и не показываются на дашборде. Кто в отпуске — от
            того не ждут отчёт и ему не идут напоминания.
          </p>
        </div>
