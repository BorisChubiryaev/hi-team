        ...
        <div className="mt-16 border-t border-line pt-10">
          ...
          <Section title="Что где находится">
            <div className="overflow-hidden rounded-xl border border-line">
              {[
                ...
                ["Команда", "Роли, доступ, отпуска, список почт (только LEAD/DIRECTOR)."],
              ].map(([k, v], i) => (
                <div
                  key={k}
          ...
          <Section title="Частые вопросы">
            <dl className="space-y-3">
              ...
              <div>
                <dt className="font-medium text-ink">Сотрудник в отпуске.</dt>
                <dd>
                  LEAD/DIRECTOR в разделе «Команда» ставит дату «в отпуске до».
                  Пока отпуск не кончился, от сотрудника не ждут отчёт, ему не
                  идут напоминания и он не попадает в «не сдали». Отметка сама
                  снимается, когда дата прошла.
                </dd>
              </div>
            </dl>
          </Section>
